...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            \linespread{1.2}\huge {
                ...
                Report for E-Learning Web Pages for Computer science students
    ...
    \noindent
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    %TODO 2 Consent to let the report to use by the library for public use
	...
	Roshan Magan % Please change it to your name
